...
class VQRecTokenizer(AbstractTokenizer):
    """
    Tokenizer for the VQ-Rec model.
    ...
    def __init__(self, config: dict, dataset: AbstractDataset):
        ...
        super(VQRecTokenizer, self).__init__(config, dataset)
    ...
    def _init_tokenizer(self, dataset: AbstractDataset):
        ...
        """
        # Load semantic IDs
        sem_ids_path = self.config.get('sem_ids_path', os.path.join(
